...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[0] = LAYOUT( /* Base */
		  ...
		  KC_LCTL,                KC_LGUI,  KC_SPC,          KC_LALT,          MO(1),            KC_EXEC,                    KC_LEFT, KC_DOWN,   KC_RIGHT),
		[1] = LAYOUT( /* FN */
		  ...
		  _______,      RGB_TOG,  RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______,  KC_PSCR,  KC_SLCK, KC_PAUS, RESET,     KC_PGUP,
			KC_ESC,       RGB_SPI,  RGB_SPD, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______,  _______,          EEP_RST,   KC_PGDN,
